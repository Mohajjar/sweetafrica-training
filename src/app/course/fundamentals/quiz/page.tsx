...
import { fundamentalsQuiz } from "@/lib/quiz";
...
export default function FundamentalsQuizPage() {
  ...
  const totalLessons = getTotalLessons("fundamentals");
  ...
  const handlePass = async ({
    ...
    if (!uid) return;
    await saveQuizAttempt(uid, "fundamentals", {
      percent,
      correct,
      total,
      passed: true,
    ...
    // ** UPDATED LINE **
    router.push("/course/fundamentals/quiz/success");
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <aside className="md:col-span-1">
                ...
                <div className="mt-4 text-xs text-gray-500">
                  Fundamentals Quiz (not counted as a lesson)
                </div>
              </aside>
                ...
                <article className="bg-white rounded-xl shadow-md border p-6 md:p-10">
                  <div className="flex items-center justify-between">
                    <h1 className="text-3xl font-bold text-gray-900">
                      Fundamentals of Cleaning - Quiz
                    </h1>
                    <Link
                      href="/course/fundamentals/recap"
                  ...
                  {!ready ? (
                    ...
                    <div className="mt-6 rounded-xl border p-4 bg-yellow-50 text-yellow-800">
                      ...
                      <Link href="/course/fundamentals" className="underline">
                        Go to Module
                      </Link>
                    </div>
                  ) : (
