...
/** ===========================================================
 *  PAGE: /admin/users  (Combined List + Detail via ?uid=...)
 *  =========================================================== */
...
function AdminUserDetail({ uid, onBack }: { uid: string; onBack: () => void }) {
    ...
    <section className="space-y-8">
      ...
      <div className="overflow-x-auto rounded-xl border bg-white">
        <table className="min-w-full text-sm text-gray-800">
          ...
          {/* force strong text + zebra striping */}
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <select
              ...
              disabled={ALL_MODULE_IDS.length <= 1} // keep it enabled? remove this line
              className="
  ...
  "
        ...
        <div className="mt-6 overflow-x-auto">
          {/* ⬇️ 1) add text-gray-800 */}
          <table className="min-w-full text-sm text-gray-800">
            {/* (optional) slightly darker header text */}
            <thead className="bg-gray-50 text-gray-700">
              <tr>
            ...
            {/* ⬇️ 2) zebra striping + borders on rows */}
            <tbody className="[&>tr]:border-t [&>tr]:odd:bg-white [&>tr]:even:bg-gray-50">
              {loadingAttempts ? (
                <tr>
                  <td
